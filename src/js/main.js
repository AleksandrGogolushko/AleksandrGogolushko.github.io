...
,"Верстка горизонтального landing page по Psd макету, с исопльзованием JavaScript,Scss и Gulp ","посетить","Игра Камень-Ножницы-Бумага","Верстка игры Камень-Ножницы-Бумага, с исопльзованием JavaScript,Jquery,Scss и Gulp ","посетить",
"Telegram web","Верстка веб версии Telegram, с использованием HTML и CSS","посетить","Контакты","&copy; Александр Гоголушко 2020"]
...
,"Horizontal landing page: Animal-health","HTML coding horizontal landing page on Psd layout, using JavaScript,Scss and Gulp","visit","Game Rock-Scissors-Paper","HTML coding game Rock-Scissors-Paper, using JavaScript,jQuery,Scss and Gulp","visit",
"Telegram web","HTML coding Telegram UI, using CSS and HTML, only for desctop","visit","contacts","&copy; Aleksander Gogolushko 2020"]
